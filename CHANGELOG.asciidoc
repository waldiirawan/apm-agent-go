...
https://github.com/elastic/apm-agent-go/compare/v2.2.0...main[View commits]
...
https://github.com/elastic/apm-agent-go/releases/tag/v1.0.0[View release]
 ...
 - Changed top-level package name to "apm", and canonical import path to "github.com/waldiirawan/apm-agent-go" {pull}202[#202]
