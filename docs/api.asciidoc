...
refer to the documentation at https://pkg.go.dev/github.com/waldiirawan/apm-agent-go/v2[pkg.go.dev/github.com/waldiirawan/apm-agent-go/v2],
...
type Stacktracer interface {
    StackTrace() []github.com/waldiirawan/apm-agent-go/v2/stacktrace.Frame
}
...
Please refer to the documentation at https://pkg.go.dev/github.com/waldiirawan/apm-agent-go/v2#Tracer[pkg.go.dev/github.com/waldiirawan/apm-agent-go/v2#Tracer]
for details. The configuration methods are primarily prefixed with `Set`, such as
https://pkg.go.dev/github.com/waldiirawan/apm-agent-go/v2#Tracer.SetLogger[apm#Tracer.SetLogger].
