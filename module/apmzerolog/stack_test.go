...
import (
	...
	"github.com/waldiirawan/apm-agent-go/module/apmzerolog/v2"
)
...
func TestMarshalErrorStack(t *testing.T) {
	...
	assert.Equal(t, "github.com/waldiirawan/apm-agent-go/module/apmzerolog/v2_test.funcC", record.Stack[0].Func)
	assert.Equal(t, "github.com/waldiirawan/apm-agent-go/module/apmzerolog/v2_test.funcB", record.Stack[1].Func)
	assert.Equal(t, "github.com/waldiirawan/apm-agent-go/module/apmzerolog/v2_test.funcA", record.Stack[2].Func)
