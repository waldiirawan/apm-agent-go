...
import (
	...
	_ "github.com/waldiirawan/apm-agent-go/module/apmsql/v2/sqlserver"
...
func TestQueryContext(t *testing.T) {
	...
	db, err := apmsql.Open("sqlserver", "sqlserver://sa:Password123@"+sqlserverHost+":1433?database=test_db")
